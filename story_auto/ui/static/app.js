const state = {
  ...
  wizard: { step: 1, content: '', info: null, voice: 'bm_george', style: 'natural', mode: 'hybrid_hook', ambientStyle: 'quiet_verdict', fullImage: {image_duration_seconds:30, cadence:'SEMANTIC_ADAPTIVE', motion:'AUTO_CONTINUOUS_ZOOM', audio_visualizer:true}, creating: false }
};
...
async function advanceWizard() {
  ...
  if (wizard.step === 2) {
    ...
    if (!hasInstalledVoice(wizard.voice)) { showWizardError('Choose an installed narrator before continuing.','voiceChoice'); return; }
  ...
  try {
    ...
    closeWizard(); state.wizard = {step:1,content:'',info:null,voice:wizard.voice,style:'natural',mode:wizard.mode,ambientStyle:wizard.ambientStyle,fullImage:wizard.fullImage,creating:false}; toast('Video project created.');

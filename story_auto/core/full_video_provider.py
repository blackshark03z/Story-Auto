...
_CAPABILITIES: dict[str, dict[str, Any]] = {
    "byteplus_seedance": {
        ...
        "continuity_reference_policy": "NONE",
        "initial_anchor_policy": "NONE",
    ...
    "elyum_seedance": {
        ...
        "continuity_reference_policy": "SHOT_TO_SHOT_ACCEPTED_FRAME",
        "initial_anchor_policy": "EXPLICIT_CANONICAL_ANCHOR",
